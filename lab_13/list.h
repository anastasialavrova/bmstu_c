...
void add_elem_to_sort_and_filter(tourist *new_elem, struct list_head **mas_sort,
...
tourist *load_data_from_file(const char name_file[], tourist *head,
                             struct list_head **mas_sort, struct list_head **mas_filter);
